...
},{"./routesController":12,"./routesFrontEnd":13,"Backbone":51,"underscore":79}],2:[function(require,module,exports){
...
},{"../models/projectModel":9,"Backbone":51}],3:[function(require,module,exports){
var Backbone = require('Backbone'),
...
},{"../models/songModel":10,"Backbone":51,"underscore":79}],4:[function(require,module,exports){
var Backbone = require('Backbone'),
		SongModel = require('../models/songModel');
...
},{"../models/songModel":10,"Backbone":51}],5:[function(require,module,exports){
var Backbone = require('Backbone'),
...
},{"../models/userModel":11,"Backbone":51}],6:[function(require,module,exports){
var Backbone = require('Backbone'),
    $ = require('jQuery'),
...
},{"Backbone":51}],9:[function(require,module,exports){
var Backbone = require('Backbone');
...
},{"Backbone":51}],10:[function(require,module,exports){
 var Backbone = require('Backbone');
...
},{"Backbone":51}],11:[function(require,module,exports){
var Backbone = require('Backbone');
...
module.exports = function () {
    ...
    this.readProject = function (proid) {
        $('#header').html(this.headerView.render().el);
        $('#projectList').html(this.projectCollectionView.render().el);
        ...
        self.songCollection = new SongCollection(self.projectSongs);//self.songCollection.set(projectSongs);//
        self.songCollection.url = "/project/" + projectid + "/song";
        self.songCollectionView = new SongCollectionView({
    ...
    this.queue = function () {
        var self = this;
        self.queueCollectionView = new SongCollectionView({collection: self.queueCollection, controller: self.player});
        $('#projectList').html(this.projectCollectionView.render().el);
...
},{"./collections/projectCollection":2,"./collections/queueCollection":3,"./collections/songCollection":4,"./collections/userCollection":5,"./controllers/player":6,"./models/loginModel":8,"./models/projectModel":9,"./models/songModel":10,"./models/userModel":11,"./views/aboutAugust9View":14,"./views/collectionViews/homeCollectionView":17,"./views/collectionViews/projectCollectionView":21,"./views/collectionViews/projectListItemView":22,"./views/collectionViews/songCollectionView":23,"./views/collectionViews/songListItemView":24,"./views/collectionViews/userCollectionView":25,"./views/collectionViews/userListItemView":26,"./views/formViews/editProjectForm":27,"./views/formViews/editSongForm":28,"./views/formViews/loginForm":29,"./views/formViews/projectForm":30,"./views/formViews/songForm":31,"./views/headerView":32,"./views/projectInfoView":33,"./views/songDetailsView":35,"Backbone":51,"jQuery":73}],13:[function(require,module,exports){
var Backbone     					= require('Backbone'),
		$            					= require('jQuery'),
		UserModel 						= require('./models/userModel'),
		UserCollection 				= require('./collections/userCollection'),
...
},{"./collections/projectCollection":2,"./collections/songCollection":4,"./collections/userCollection":5,"./models/loginModel":8,"./models/projectModel":9,"./models/songModel":10,"./models/userModel":11,"./views/collectionViews/homeCollectionView":17,"./views/collectionViews/projectCollectionView":21,"./views/collectionViews/projectListItemView":22,"./views/collectionViews/songCollectionView":23,"./views/collectionViews/songListItemView":24,"./views/collectionViews/userCollectionView":25,"./views/collectionViews/userListItemView":26,"./views/formViews/editSongForm":28,"./views/formViews/loginForm":29,"./views/formViews/projectForm":30,"./views/formViews/songForm":31,"./views/headerView":32,"./views/songDetailsView":35,"Backbone":51,"jQuery":73}],14:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../templates/aboutAugust9.hbs":36,"backbone":53,"jQuery":73,"underscore":79}],15:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
...
},{"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],16:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/player.hbs":42,"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],17:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./homeListItemView":18,"Backbone":51,"jQuery":73,"underscore":79}],18:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/homeListItem.hbs":40,"backbone":53,"jQuery":73,"underscore":79}],19:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/playerControls.hbs":43,"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],20:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/player.hbs":42,"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],21:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./projectListItemView":22,"Backbone":51,"jQuery":73,"underscore":79}],22:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/projectListItem.hbs":46,"backbone":53,"jQuery":73,"underscore":79}],23:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./songListItemView":24,"Backbone":51,"jQuery":73,"underscore":79}],24:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/songListItem.hbs":49,"backbone":53,"jQuery":73,"underscore":79}],25:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./userListItemView":26,"Backbone":51,"jQuery":73,"underscore":79}],26:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/userListItem.hbs":50,"backbone":53,"jQuery":73,"underscore":79}],27:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/editProjectForm.hbs":37,"backbone":53,"jQuery":73,"underscore":79}],28:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/editSongForm.hbs":38,"backbone":53,"jQuery":73,"underscore":79}],29:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/login.hbs":41,"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],30:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/projectForm.hbs":44,"backbone":53,"jQuery":73,"underscore":79}],31:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/songForm.hbs":47,"backbone":53,"jQuery":73,"underscore":79}],32:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../templates/header.hbs":39,"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],33:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../templates/projectInfo.hbs":45,"backbone":53,"handlebars":70,"jQuery":73,"underscore":79}],34:[function(require,module,exports){
...
},{"jquery":78,"jquery-ui/draggable":75}],35:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../templates/songInfo.hbs":48,"backbone":53,"jQuery":73,"underscore":79}],36:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "\n<section class=\"\">\n	<div id=\"\" class=\"imgCrop\">\n		<img src=\"./media/images/summer.jpeg\" alt=\"Sommereng i solnedgang\"/>\n	</div>\n			<header  class=\"\">\n			<h4> About august9</h4>\n		</header>\n	<div id=\"\" class=\"projectInfo\">\n		<p>Ut eget eros tellus. Cras sodales neque lectus, vitae faucibus mauris congue in. Mauris aliquam cursus ipsum, vitae venenatis libero. Nulla vitae sodales lacus. Aliquam eget nunc bibendum, porttitor nulla ac, tincidunt nunc. Aenean bibendum dui vel mi congue eleifend. Aenean mollis, arcu in elementum iaculis, nisl lacus molestie ligula, sit amet vehicula mauris mauris a arcu. Integer justo diam, vestibulum et ultrices tempus, varius eget sem. Aliquam dignissim rutrum vehicula. Proin ut nibh libero. Nulla elementum, erat non convallis rutrum, mauris velit viverra elit, ac consectetur urna mauris ac magna. Ut leo mauris, auctor ut pretium nec, fermentum ac tellus. Aliquam venenatis arcu eu orci accumsan, sit amet pellentesque turpis feugiat. Cras rutrum commodo ipsum a sollicitudin. Phasellus tempus, nulla ultricies consectetur blandit, massa felis ornare risus, quis iaculis lectus mi at est. Vestibulum sed ex faucibus dui lobortis blandit.\n\n</p>\n	</div>\n</section>\n<span></span>\n\n\n";
  });

},{"hbsfy/runtime":72}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"container modalWindow\">\n    <h1><span class=\"form august9-songForm\"></span>Edit ";
...
},{"hbsfy/runtime":72}],38:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"container modalWindow\">\n    <h1><span class=\"form august9-songForm\"></span>Edit song</h1>\n\n    <!-- show any messages that come back with authentication -->\n    <!--<% if (message.length > 0) { %>\n        <div class=\"alert alert-danger\"><%= message %></div>\n    <% } %>-->\n<form >\n	<div class=\"form-group col-xs-12 col-sm-5\">   	\n		<label for=\"title\">Song title:</label>\n		<input class=\"form-control\" type=\"text\" name=\"title\" value=\"";
...
},{"hbsfy/runtime":72}],39:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
function program3(depth0,data) {
  ...
  return "\n					<img src=\"./media/images/summer.jpg\" alt=\"Sommereng i solnedgang\"/>	\n				";
  }
...
},{"hbsfy/runtime":72}],41:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":72}],42:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":72}],43:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":72}],45:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":72}],46:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "\">\n			<div id=\"\" class=\"projectImgCrop\">\n				<img src=\"";
  if (helper = helpers.imgthumb) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.imgthumb); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\"/>\n			</div>\n			<p>";
  if (helper = helpers.projectname) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.projectname); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</p>\n		</a>\n	</div>\n</div>\n<div class=\"row\">\n	<div class=\"editButtons col-sm-4\">\n		<a class=\"admin hidden\" href=\"#/project/";
  if (helper = helpers.id) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.id); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
  ...
  buffer += escapeExpression(stack1)
    + "/delete\"> <button type=\"button\" class=\"btn btn-xs\" >Del</button></a>\n	</div>\n	<div class=\"editButtons col-sm-4\">\n		<a class=\"admin hidden\" href=\"#/project/";
  if (helper = helpers.id) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.id); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
...
},{"hbsfy/runtime":72}],47:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"container modalWindow\">\n    <h1><span class=\"form august9-songForm\"></span>Upload song</h1>\n\n    <!-- show any messages that come back with authentication -->\n    <!--<% if (message.length > 0) { %>\n        <div class=\"alert alert-danger\"><%= message %></div>\n    <% } %>-->\n<form id =  \"uploadForm\"\n     enctype   =  \"multipart/form-data\"\n     action    =  \"/project/";
  if (helper = helpers.projectid) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.projectid); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
...
},{"hbsfy/runtime":72}],48:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</li>\n		<li class=\"productionstatus\">Productionstatus:";
  if (helper = helpers.productionstatus) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.productionstatus); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
...
},{"hbsfy/runtime":72}],49:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":72}],50:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
function program3(depth0,data) {
  ...
  return "\n			<img src=\"./media/avatars/default-avatar.jpg\" alt=\"default avatar\"/>\n		";
  }

  buffer += "\n	<div id=\"userImg\" class=\"imgCrop\">\n		";
...
},{"hbsfy/runtime":72}],51:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.1
...
},{"jquery":78,"underscore":52}],52:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"dup":51,"jquery":78,"underscore":54}],54:[function(require,module,exports){
...
},{"./handlebars.runtime":57,"./handlebars/compiler/ast":59,"./handlebars/compiler/base":60,"./handlebars/compiler/compiler":61,"./handlebars/compiler/javascript-compiler":62}],57:[function(require,module,exports){
"use strict";
/*globals Handlebars: true */
...
exports["default"] = Handlebars;
},{"./handlebars/base":58,"./handlebars/exception":66,"./handlebars/runtime":67,"./handlebars/safe-string":68,"./handlebars/utils":69}],58:[function(require,module,exports){
"use strict";
...
},{"./exception":66,"./utils":69}],59:[function(require,module,exports){
"use strict";
var Exception = require("../exception")["default"];
...
exports["default"] = AST;
},{"../exception":66}],60:[function(require,module,exports){
"use strict";
...
exports.parse = parse;
},{"./ast":59,"./parser":63}],61:[function(require,module,exports){
"use strict";
var Exception = require("../exception")["default"];
...
},{"../base":58,"../exception":66}],63:[function(require,module,exports){
"use strict";
/* jshint ignore:start */
...
exports.noop = noop;
},{"./base":58,"./exception":66,"./utils":69}],68:[function(require,module,exports){
"use strict";
...
},{"../dist/cjs/handlebars":56,"../dist/cjs/handlebars/compiler/printer":64,"../dist/cjs/handlebars/compiler/visitor":65,"fs":55}],71:[function(require,module,exports){
// Create a simple path alias to allow browserify to resolve
// the runtime on a supported path.
module.exports = require('./dist/cjs/handlebars.runtime');

},{"./dist/cjs/handlebars.runtime":57}],72:[function(require,module,exports){
module.exports = require("handlebars/runtime")["default"];

},{"handlebars/runtime":71}],73:[function(require,module,exports){
/*!
...
},{"jquery":78}],75:[function(require,module,exports){
var jQuery = require('jquery');
require('./core');
require('./mouse');
require('./widget');
...
},{"./core":74,"./mouse":76,"./widget":77,"jquery":78}],76:[function(require,module,exports){
var jQuery = require('jquery');
require('./widget');
...
},{"./widget":77,"jquery":78}],77:[function(require,module,exports){
var jQuery = require('jquery');
...
},{"jquery":78}],78:[function(require,module,exports){
