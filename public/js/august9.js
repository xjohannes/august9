...
},{"./routesController":12,"./routesFrontEnd":13,"Backbone":50,"underscore":74}],2:[function(require,module,exports){
...
},{"../models/projectModel":9,"Backbone":50}],3:[function(require,module,exports){
var Backbone = require('Backbone'),
...
module.exports = Backbone.Collection.extend({
	...
	initialize: function(options) {
		...
		this.add(songItem);
		songItem = new SongModel({id: 121});
		this.add(songItem);
		songItem = new SongModel({id: 122});
		this.add(songItem);
		songItem = new SongModel({id: 123});
		this.add(songItem);

		songItem = new SongModel({id: 125});
		songItem.set({projectId: 107});
		this.add(songItem);
		songItem = new SongModel({id: 124});
		this.add(songItem);
		...
		this.projectList.each(function(element, index, list) {
			element.fetch({
				success: function(project) {
					//console.log('project');
					//console.log(project);
					let projectSongs = project.attributes.songs;
	...
	//console.log("QueueCollecton. At?");
		console.log(this.at(this.length-1));
...
},{"../models/songModel":10,"Backbone":50,"underscore":74}],4:[function(require,module,exports){
var Backbone = require('Backbone'),
		SongModel = require('../models/songModel');
...
},{"../models/songModel":10,"Backbone":50}],5:[function(require,module,exports){
var Backbone = require('Backbone'),
...
},{"../models/userModel":11,"Backbone":50}],6:[function(require,module,exports){
var Backbone     					= require('Backbone'),
		$            					= require('jQuery'),
...
module.exports = function() {
	// private variables:
		this.initialize = function(options) {
			this.options 				 = options || {};
			this.projectList 		 = this.options.projectList;
			this.queueCollection = this.options.collection;
			this.currentSong 		 = this.queueCollection.getQueueTop();
			//this.currentSong.on('playing', function() {console.log("PLAYING");});
			// create views
			//console.log("PlayerController. model:");
		...
		this.play = function (songModel) { 
			if(this.currentSong.isPlaying()) {
				...
				this.currentSong = this.queueCollection.getQueueTop();
				this.playerControls.registerNewModel(this.currentSong);
		...
		this.playFromList = function (songModel) { 
			if(songModel.isPlaying() ) {
				songModel.stop();
			} else if(this.currentSong.isPlaying()) {
				this.currentSong.stop();
...
},{"../views/collectionViews/currentSongView":15,"../views/collectionViews/durationsView":16,"../views/collectionViews/playerControlsView":19,"../views/collectionViews/playerView":20,"Backbone":50,"jQuery":72}],7:[function(require,module,exports){
var App = require('./app');
var august9 = new App();
...
},{"Backbone":50}],9:[function(require,module,exports){
var Backbone = require('Backbone');
...
},{"Backbone":50}],10:[function(require,module,exports){
 var Backbone = require('Backbone');
...
},{"Backbone":50}],11:[function(require,module,exports){
var Backbone = require('Backbone');
...
},{"Backbone":50}],12:[function(require,module,exports){
var Backbone     					= require('Backbone'),
		$            					= require('jQuery'),
		UserModel 						= require('./models/userModel'),
...
},{"../../templates/aboutAugust9.hbs":35,"backbone":52,"jQuery":72,"underscore":74}],15:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
...
},{"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],16:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/player.hbs":41,"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],17:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./homeListItemView":18,"Backbone":50,"jQuery":72,"underscore":74}],18:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/homeListItem.hbs":39,"backbone":52,"jQuery":72,"underscore":74}],19:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
module.exports = Backbone.View.extend({
	...
	initialize: function(options) {
		...
		this.controller = options.controller;
		//this.listenTo(this.model, 'change:token', this.clean);
		console.log("playerControlsView. Initialize");
		console.log(this.model);
		this.model.on('playing', this.disablePlayButton, this);
		this.model.on('pause', this.enablePlayButton, this);
		this.model.on('playing', console.log("PlayerControlsView. Caught playing event"), this);
...
},{"../../../templates/playerControls.hbs":42,"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],20:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/player.hbs":41,"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],21:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./projectListItemView":22,"Backbone":50,"jQuery":72,"underscore":74}],22:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/projectListItem.hbs":45,"backbone":52,"jQuery":72,"underscore":74}],23:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./songListItemView":24,"Backbone":50,"jQuery":72,"underscore":74}],24:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/songListItem.hbs":48,"backbone":52,"jQuery":72,"underscore":74}],25:[function(require,module,exports){
var Backbone = require('Backbone'),
		_ = require('underscore'),
		$ = require('jQuery'),
...
},{"./userListItemView":26,"Backbone":50,"jQuery":72,"underscore":74}],26:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/userListItem.hbs":49,"backbone":52,"jQuery":72,"underscore":74}],27:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/editProjectForm.hbs":36,"backbone":52,"jQuery":72,"underscore":74}],28:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/editSongForm.hbs":37,"backbone":52,"jQuery":72,"underscore":74}],29:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../../templates/login.hbs":40,"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],30:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/projectForm.hbs":43,"backbone":52,"jQuery":72,"underscore":74}],31:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../../templates/songForm.hbs":46,"backbone":52,"jQuery":72,"underscore":74}],32:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../templates/header.hbs":38,"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],33:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore'),
		Handlebars = require('handlebars');
...
},{"../../templates/projectInfo.hbs":44,"backbone":52,"handlebars":69,"jQuery":72,"underscore":74}],34:[function(require,module,exports){
var Backbone = require('backbone'),
		$ = require('jQuery'),
		_ = require('underscore');
...
},{"../../templates/songInfo.hbs":47,"backbone":52,"jQuery":72,"underscore":74}],35:[function(require,module,exports){
...
},{"hbsfy/runtime":71}],36:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],37:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],38:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],39:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],40:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],41:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</div>\n	</div>\n</div>\n\n<div id=\"volume\" class=\"\"></div>\n<div id=\"queue\" class=\"\"></div>\n\n\n\n\n\n";
  return buffer;
  });

},{"hbsfy/runtime":71}],42:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],43:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":71}],44:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"jquery":73,"underscore":51}],51:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"dup":50,"jquery":73,"underscore":53}],53:[function(require,module,exports){
...
},{"../dist/cjs/handlebars":55,"../dist/cjs/handlebars/compiler/printer":63,"../dist/cjs/handlebars/compiler/visitor":64,"fs":54}],70:[function(require,module,exports){
// Create a simple path alias to allow browserify to resolve
// the runtime on a supported path.
module.exports = require('./dist/cjs/handlebars.runtime');

},{"./dist/cjs/handlebars.runtime":56}],71:[function(require,module,exports){
